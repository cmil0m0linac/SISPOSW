          ...
          <div class="col-md-9 col-sm-9">
            <div class="slider-wrapper theme-default">
              ...
              <div id="htmlcaption" class="nivo-html-caption">
                <div class="slider-caption">
                  <div class="slider-text">
                    <h5 class="wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">Oferta Exclusiva
                      -20% Dcto esta semana </h5>
                    <h1 class="wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">Línea Gamer
                      VR<br>Hasta 60% Dcto</h1>
              ...
              <div id="htmlcaption2" class="nivo-html-caption">
                <div class="slider-caption">
                  <div class="slider-text">
                    <h5 class="wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">Oferta Exclusiva
                      -10% dcto esta semana </h5>
                    <h1 class="wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">Nuevo <br>Galaxy
                      S20 Ultra</h1>
              ...
              <div id="htmlcaption3" class="nivo-html-caption">
                <div class="slider-caption">
                  <div class="slider-text">
                    <h5 class="wow animated fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.5s">Somos Partners
                      Oficiales de Microsoft</h5>
                    <h1 class="wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">Laptop <br>Surface
                      Pro 7</h1>
                    <h4 class="wow animated fadeInLeft" data-wow-duration="2s" data-wow-delay="0.5s">Desde
            ...
            <div class="shop-tab-menu">
              <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 ">
                  <div class="shop-tab">
                    <ul>
                      <li class="active"><a data-toggle="tab" href="#grid-view"><i class="ion-android-apps"></i></a>
                      </li>
