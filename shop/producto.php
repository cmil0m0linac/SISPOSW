...
<!-- Mirrored from d29u17ylf1ylz9.cloudfront.net/ SysPOSw/single-product.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Mar 2020 18:57:19 GMT -->
<head>
	<meta charset="utf-8">
		                ...
		                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="single-product-tab-content tab-content">
                                <div id="w1" class="tab-pane fade in active">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="img/single-product/large/1.jpg">
                                ...
                                <div id="w3" class="tab-pane fade">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="img/single-product/large/3.jpg">
                                ...
                                <div id="w4" class="tab-pane fade">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="img/single-product/large/4.jpg">
                                            <img src="img/single-product/large/4.jpg" alt="">
                                        </a>
                                    </div>
                                </div>  
                                <div id="w5" class="tab-pane fade">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="img/single-product/large/5.jpg">
                                            <img src="img/single-product/large/5.jpg" alt="">
                                        </a>
                                    </div>
                                </div>  
                                <div id="w6" class="tab-pane fade">
                                    <div class="easyzoom easyzoom--overlay">
                                        <a href="img/single-product/large/6.jpg">
		                    ...
		                    <div class="single-product-tab">
		                        <div class="single-product-tab-menu owl-carousel">
		                            <a data-toggle="tab" href="#w1"><img src="img/product-thumb/1.jpg" alt=""></a>
		                            <a data-toggle="tab" href="#w2"><img src="img/product-thumb/3.jpg" alt=""></a>
		                            <a data-toggle="tab" href="#w3"><img src="img/product-thumb/2.jpg" alt=""></a>
		                            <a data-toggle="tab" href="#w4"><img src="img/product-thumb/4.jpg" alt=""></a>
		                            <a data-toggle="tab" href="#w5"><img src="img/product-thumb/5.jpg" alt=""></a>
		                            <a data-toggle="tab" href="#w6"><img src="img/product-thumb/6.jpg" alt=""></a>
		                        </div>
		                    </div>
		                    <!--Single Product Tab Menu Start-->
		                </div>
		            ...
		            <div class="related-products owl-carousel">
                        ...
                        <div class="col-md-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="single-product.html">
                                        <img class="first-img" src="img/product/25.jpg" alt="">
                                        <img class="hover-img" src="img/product/26.jpg" alt="">
                                    </a>
                                    <span class="sicker">-7%</span>
                                    <ul class="product-action">
                                        <li><a href="#"><i class="ion-android-favorite-outline"></i></a></li>
