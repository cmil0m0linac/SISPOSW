...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($resultado->num_rows > 0) {
        ...
        $conexion->close();
        $respuesta['msg'] = "El Empleado que intenta editar no existe";
    ...
    $sql1 = "DELETE from empleados where Usuario = " . $fila['Id_usuario'];
    $resultado1 = $conexion->query($sql1)
        or die('Error al intentar borrar registro en Empleados');
